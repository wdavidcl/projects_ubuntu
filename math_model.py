...
y = np.array([5,6,7,10,13,14,15,16,17,17,18,19,21,23,37,58,111],  dtype=float)
plt.xlim(0,30)
plt.ylim(0,1500)
plt.xlabel('(Marzo)')
plt.ylabel('(Covid-19 casos confirmados)')
plt.plot(u, y, 'r') # plotting t, a separately 
u_pred = np.arange(30)+1
df = pd.DataFrame(data = u_pred,columns=['Dia'])
